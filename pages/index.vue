<template>
  <div>
    <StyledSectionWidth
      class="z-30 relative pt-12 overflow-visible mt-48 mb-24"
    >
      <div
        class="
          overflow-x-hidden
        ...
        >
          ...
          <div class="my-8 mb-4">
            <nuxt-link :to="`projects/${project.slug}`">
              <StyledButton class="px-6 py-4"> See Project </StyledButton>
            </nuxt-link>
          </div>
        </div>
      </div>
